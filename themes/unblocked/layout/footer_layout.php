                            ...
                            <div class="inner-contact-box">
                                <div id="fcf-form">
                                    <form class="fcf-form-class" id="contact-form" method="post">
                                        <h1 class="home-title"><?php echo ucwords($title); ?></h1>
                                        <div class="field">
...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({});
                                                        ...
                                                        <option value="Game's Error Report">Game's Error Report</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="field">
                                            <div class="buttons">
                                                <button id="fcf-button" type="submit" class="button is-link is-medium is-fullwidth" style="">Send Message</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div id="fcf-thank-you" style="display:none" class="field">
                                    ...
                                    <br><br>
                                    <button type="button" class="button is-link is-medium"><a href="/" onclick="clickLink(event, '', 'home')">Go to home page</a></button>
                                    <br><br>
                                </div>
                            </div>
                        </div>
        ...
        <?php else : ?>
            <div class="row">
                <div class="text-area">
                    <div class="article game__content">
                        <div class="top-header">
                            <h1 class="home-title"><?php echo ucwords($title); ?></h1>
