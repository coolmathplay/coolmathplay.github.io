            ...
            <?php if (strpos($game->source_html, 'suika-game') !== false) : ?>
                <style>
                    ...
                    .gamePlayerSplash .gamePlayerSplashContent {
                        ...
                        height: 100%;
                        z-index: 10;
                        box-shadow: 0 0 0 0 #fff, 10px 20px 21px rgba(0, 0, 0, .4);
                        position: relative;
                        transition: box-shadow .2s
                    }

                    .gamePlayerSplash .gamePlayerSplashContent:hover {
                        box-shadow: -2px -2px 10px 1px #fff, 10px 20px 21px rgba(0, 0, 0, .4)
                    }
                    ...
                    .gamePlayerSplashContent .gamePlayerCenterContent .gamePlayerPrerollCTA:hover span:before {
                        animation: .3s infinite gamePlayerKnock
                    }
                    ...
                    .gamePlayerThumb:hover {
                        transform: scale(1.1);
                        box-shadow: -2px -2px 10px 1px #fff, 0 5px 40px rgba(0, 0, 0, .4)
                    }

                    .gamePlayerThumb>div {
                        border-radius: 50%;
                        background-image: url(<?php echo \helper\image::get_thumbnail($game->image, 200, 200, 'm') ?>)
                    }
                    ...
                    .gamePlayerBg .gamePlayerBgImage {
                        background-image: url('<?php echo \helper\image::get_thumbnail($game->image, 180, 135, 'm') ?>') !important
                    }
